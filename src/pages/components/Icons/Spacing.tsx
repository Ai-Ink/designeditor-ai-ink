function Spacing({size, color}: {size: number; color: string}) {
  return (
    <svg
      height={size}
      viewBox="0 0 24 24"
    ...
    >
      <path d="M21 6.7959H10.5V8.2959H21V6.7959Z" fill={color} />
      <path d="M21 12.0459H10.5V13.5459H21V12.0459Z" fill={color} />
      <path d="M21 17.2959H10.5V18.7959H21V17.2959Z" fill={color} />
      <path
